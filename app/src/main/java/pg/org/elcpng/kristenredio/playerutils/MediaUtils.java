package pg.org.elcpng.kristenredio.playerutils;
...
public class MediaUtils {
    ...
    public static void setRingtone(Context context, ClsTrack track) {
        ...
        if (uri == null || context.getContentResolver() == null) {
            Toast.makeText(context, context.getString(R.string.error_text), Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (newUri == null) {
            ...
            Toast.makeText(context, context.getString(R.string.set_as_ringtone_text), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    static void setRingtone(Context context, long id) {
        ...
        try {
            if (cursor != null && cursor.getCount() == 1) {
                ...
                String message = context.getString(R.string.set_as_ringtone_text) + cursor.getString(2);
